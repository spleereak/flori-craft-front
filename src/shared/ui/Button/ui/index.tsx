  ...
  return (
    <button
      className={cn(
        ...
        appearance === "primary" &&
          "desktop:w-491 desktop:h-82 bg-brown p w-238 h-41 text-white hover:opacity-80 active:opacity-80",
        appearance === "outline" &&
        ...
        appearance === "accent" &&
          "desktop:w-234 desktop:h-66 bg-light-grey h3 hover:bg-brown active:bg-brown w-156 h-33 text-black hover:text-white active:text-white",
