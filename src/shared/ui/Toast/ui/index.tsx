    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="desktop:top-40 w-330 desktop:w-618 z-3000 desktop:px-40 desktop:py-30 desktop:gap-92 gap-42 bg-light-grey desktop:rounded-2xl fixed left-1/2 top-10 flex h-max -translate-x-1/2 flex-col items-center rounded-md p-16"
        >
          <div
